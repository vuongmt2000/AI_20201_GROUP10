...
class FlappyBird(object):
    ...
    background_image = pygame.image.load('assets/sprites/background-black.png').convert()

    pipe_images = [rotate(pygame.image.load('assets/sprites/pipe-green.png').convert_alpha(), 180),
